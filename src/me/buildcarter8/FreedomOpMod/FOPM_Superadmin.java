...
public class FOPM_Superadmin {
	 private final String name;
	    ...
	    public FOPM_Superadmin(String name, List<String> ips, Date last_login, String custom_login_message, boolean is_senior_admin, List<String> console_aliases, boolean is_activated)
	    {
	    ...
	    public FOPM_Superadmin(String name, ConfigurationSection section)
	    {
	        this.name = name.toLowerCase();
